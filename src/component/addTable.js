...
const addTable = ({ navigation }) => {
    ...
    return (
        <View style={{ flex: 1 ,justifyContent:'center'}}>
            ...
            <TextInput
                    style={{ width: '80%', height: 60, backgroundColor: '#CCCCCC', fontSize: 15, borderRadius: 10,paddingLeft:20 }}
                    placeholder="id Ban "
                ...
                onPress={()=>{
                    ...
                    <Text style={{ alignItems: 'center', justifyContent: 'center' }}>Add</Text>
                </TouchableOpacity>
                ...
                onPress={()=>{
                   getData();
                    ...
                    <Text style={{ alignItems: 'center', justifyContent: 'center' }}>red</Text>
                </TouchableOpacity>
