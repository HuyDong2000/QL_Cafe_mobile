        ...
        <View style={styles.container}>
             <View style={{  alignItems: 'center' ,justifyContent:'center'}}>
                <View style={{
                    ...
                    >
                        <Image source={require('../image/back.png')} style={{ width: 30, height: 30, marginLeft:20}}></Image>
                    </TouchableOpacity>

                    <Text style={{ fontSize: 20, fontWeight: '700', marginLeft: 20 }}>Edit Product</Text>
                    <TouchableOpacity
                        onPress={() => {
                            navigation.navigate('AddFood')
                        }}
                    >
                        <Image source={require('../image/add-outline.png')} style={{ width: 40, height: 40, marginLeft: '55%' }}></Image>
                    </TouchableOpacity>

                </View>
            </View>
            <View style={{alignItems:'center'}}>
                <Text style={{fontSize:40 , fontWeight:'700'}}>Quản lý món</Text>
            </View>
