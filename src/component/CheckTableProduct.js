                                ...
                                <View style={{ width: '50%', flexDirection: 'row-reverse', alignSelf: 'center', marginLeft: 30 }}>
                                    ...
                                    >
                                        <Image source={require('../image/angle-right-solid.png')}
                                            style={{ width: 20, height: 20, marginTop: 4, marginRight: 20 }}></Image>
                                    </TouchableOpacity>
                                    <Text style={{ fontSize: 20, fontWeight: '700', color: '#009966', marginRight: 10 }}>
                                        {'$' + getTotal(item.data.cart)}</Text>
                                </View>
                            </View>
                        </View>
                    )
